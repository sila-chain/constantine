 ...
 */
#ifndef __CTT_H_SILA_BLS_SIGNATURES__
#define __CTT_H_SILA_BLS_SIGNATURES__
...
struct ctt_sila_bls_fp { byte raw[48]; };
struct ctt_sila_bls_fp2 { struct ctt_sila_bls_fp coords[2]; };

typedef struct { byte raw[32]; } ctt_sila_bls_seckey;
typedef struct { struct ctt_sila_bls_fp  x, y; } ctt_sila_bls_pubkey;
typedef struct { struct ctt_sila_bls_fp2 x, y; } ctt_sila_bls_signature;
...
typedef struct ctt_sila_bls_batch_sig_accumulator ctt_sila_bls_batch_sig_accumulator;

typedef enum __attribute__((__packed__)) {
    cttSilaBls_Success,
    cttSilaBls_VerificationFailure,
    cttSilaBls_InputsLengthsMismatch,
    cttSilaBls_ZeroLengthAggregation,
    cttSilaBls_PointAtInfinity,
} ctt_sila_bls_status;

static const char* ctt_sila_bls_status_to_string(ctt_sila_bls_status status) {
  ...
  return "cttSilaBls_InvalidStatusCode";
}
...
ctt_bool ctt_sila_bls_pubkey_is_zero(const ctt_sila_bls_pubkey* pubkey) __attribute__((warn_unused_result));
ctt_bool ctt_sila_bls_signature_is_zero(const ctt_sila_bls_signature* sig) __attribute__((warn_unused_result));

ctt_bool ctt_sila_bls_pubkeys_are_equal(const ctt_sila_bls_pubkey* a,
                                       const ctt_sila_bls_pubkey* b) __attribute__((warn_unused_result));
ctt_bool ctt_sila_bls_signatures_are_equal(const ctt_sila_bls_signature* a,
                                          const ctt_sila_bls_signature* b) __attribute__((warn_unused_result));
 ...
 */
ctt_codec_scalar_status ctt_sila_bls_validate_seckey(const ctt_sila_bls_seckey* seckey) __attribute__((warn_unused_result));

/** Validate the public key.
 *
 *  This is an expensive operation that can be cached.
 */
ctt_codec_ecc_status ctt_sila_bls_validate_pubkey(const ctt_sila_bls_pubkey* pubkey) __attribute__((warn_unused_result));

/** Validate the signature.
 *
 *  This is an expensive operation that can be cached.
 */
ctt_codec_ecc_status ctt_sila_bls_validate_signature(const ctt_sila_bls_signature* pubkey) __attribute__((warn_unused_result));
 ...
 */
void ctt_sila_bls_serialize_seckey(byte dst[32], const ctt_sila_bls_seckey* seckey);

/** Serialize a public key in compressed (Zcash) format
 *
 *  Returns cttCodecEcc_Success if successful
 */
ctt_codec_ecc_status ctt_sila_bls_serialize_pubkey_compressed(byte dst[48], const ctt_sila_bls_pubkey* pubkey) __attribute__((warn_unused_result));

/** Serialize a signature in compressed (Zcash) format
 *
 *  Returns cttCodecEcc_Success if successful
 */
ctt_codec_ecc_status ctt_sila_bls_serialize_signature_compressed(byte dst[96], const ctt_sila_bls_signature* sig) __attribute__((warn_unused_result));
 ...
 */
ctt_codec_scalar_status ctt_sila_bls_deserialize_seckey(ctt_sila_bls_seckey* seckey, const byte src[32]) __attribute__((warn_unused_result));
 ...
 *  Returns cttCodecEcc_Success if successful
 */
ctt_codec_ecc_status ctt_sila_bls_deserialize_pubkey_compressed_unchecked(ctt_sila_bls_pubkey* pubkey, const byte src[48]) __attribute__((warn_unused_result));
 ...
 *  Returns cttCodecEcc_Success if successful
 */
ctt_codec_ecc_status ctt_sila_bls_deserialize_pubkey_compressed(ctt_sila_bls_pubkey* pubkey, const byte src[48]) __attribute__((warn_unused_result));
 ...
 *  Returns cttCodecEcc_Success if successful
 */
ctt_codec_ecc_status ctt_sila_bls_deserialize_signature_compressed_unchecked(ctt_sila_bls_signature* sig, const byte src[96]) __attribute__((warn_unused_result));
 ...
 *  Returns cttCodecEcc_Success if successful
 */
ctt_codec_ecc_status ctt_sila_bls_deserialize_signature_compressed(ctt_sila_bls_signature* sig, const byte src[96]) __attribute__((warn_unused_result));
 ...
 */
void ctt_sila_bls_derive_pubkey(ctt_sila_bls_pubkey* pubkey, const ctt_sila_bls_seckey* seckey);
 ...
 *  - An invalid secret key will leak whether it's all zero or larger than the curve order.
 */
void ctt_sila_bls_sign(ctt_sila_bls_signature* sig,
                      const ctt_sila_bls_seckey* seckey,
 ...
 */
ctt_sila_bls_status ctt_sila_bls_verify(const ctt_sila_bls_pubkey* pubkey,
                                      const byte* message, size_t message_len,
                                      const ctt_sila_bls_signature* sig) __attribute__((warn_unused_result));
 ...
 */
ctt_sila_bls_status ctt_sila_bls_fast_aggregate_verify(const ctt_sila_bls_pubkey pubkeys[], size_t pubkeys_len,
                                                     const byte* message, size_t message_len,
                                                     const ctt_sila_bls_signature* aggregate_sig) __attribute__((warn_unused_result));
 ...
 */
ctt_sila_bls_status ctt_sila_bls_aggregate_verify(const ctt_sila_bls_pubkey* pubkeys,
...
ctt_sila_bls_status ctt_sila_bls_batch_verify(const ctt_sila_bls_pubkey pubkeys[],
					    const ctt_span messages[],
					    const ctt_sila_bls_signature signatures[],
					    size_t len,
 ...
 */
ctt_sila_bls_batch_sig_accumulator* ctt_sila_bls_alloc_batch_sig_accumulator();

/**
 * Function to free the storage allocated by the above.
 * Users of the C API *must* use this.
 */
void ctt_sila_bls_free_batch_sig_accumulator(ctt_sila_bls_batch_sig_accumulator *ptr);
 ...
 */
void ctt_sila_bls_init_batch_sig_accumulator(
    ctt_sila_bls_batch_sig_accumulator* ctx,
 ...
 *
 */
ctt_bool ctt_sila_bls_update_batch_sig_accumulator(
    ctt_sila_bls_batch_sig_accumulator* ctx,
    const ctt_sila_bls_pubkey* pubkey,
    const byte* message, size_t message_len,
    const ctt_sila_bls_signature* signature
    ) __attribute__((warn_unused_result));
 ...
 */
ctt_bool ctt_sila_bls_final_verify_batch_sig_accumulator(ctt_sila_bls_batch_sig_accumulator* ctx) __attribute__((warn_unused_result));
...
#endif // __CTT_H_SILA_BLS_SIGNATURES__
