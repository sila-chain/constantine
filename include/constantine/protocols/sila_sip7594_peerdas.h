 ...
 */
#ifndef __CTT_H_SILA_SIP7594_PEERDAS__
#define __CTT_H_SILA_SIP7594_PEERDAS__
...
// Sila SIP-7594 PeerDAS constants
// ------------------------------------------------------------------------------------------------
...
// Sila SIP-7594 PeerDAS types
// ------------------------------------------------------------------------------------------------

typedef struct { byte raw[CTT_BYTES_PER_CELL]; } ctt_sila_kzg_cell;

// Sila SIP-7594 PeerDAS Interface
// ------------------------------------------------------------------------------------------------
 ...
 */
ctt_sila_kzg_status ctt_sila_kzg_compute_cells_and_kzg_proofs(
        const ctt_sila_kzg_context* ctx,
        ctt_sila_kzg_cell* cells,
        ctt_sila_kzg_proof* proofs,
 ...
 */
ctt_sila_kzg_status ctt_sila_kzg_verify_cell_kzg_proof_batch(
        const ctt_sila_kzg_context* ctx,
        const ctt_sila_kzg_commitment* commitments,
        const uint64_t* cell_indices,
        const ctt_sila_kzg_cell* cells,
 ...
 *  @return                 cttSilaKzg_Success on success, error status otherwise
 */
ctt_sila_kzg_status ctt_sila_kzg_recover_cells_and_kzg_proofs(
        const ctt_sila_kzg_context* ctx,
        ctt_sila_kzg_cell* recovered_cells,
        ctt_sila_kzg_proof* recovered_proofs,
        const uint64_t* cell_indices,
        const ctt_sila_kzg_cell* cells,
        size_t num_cells
) __attribute__((warn_unused_result));
...
#endif // __CTT_H_SILA_SIP7594_PEERDAS__
