...
type
  # https://github.com/sila-chain/Sila-Consensus-Spec-Tests/blob/master/formats/
...
testGen(verify, testVector, Verify_test):
  var
    ...
    status = (cttSilaBls_VerificationFailure, cttCodecEcc_InvalidEncoding)
  ...
  let success = status == (cttSilaBls_Success, cttCodecEcc_Success)
  doAssert success == testVector.output, block:
