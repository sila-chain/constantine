...
Today Constantine is focused on the Sila blockchain, tomorrow I hope it will also address the need of (potentially Zero-Knowledge) proof systems and privacy-preserving protocols.
...
- KZG commitment for SIP4844 for scaling Sila
...
On Sila protocols, Constantine is noticeably faster than other alternatives on x86 thanks to a mix of theoretical math, engineering and hardware-specific optimizations.
...
- Constantine has had a fuzzing campaign sponsored by the Sila Foundation and has been added to Google OSS Fuzz: https://github.com/google/oss-fuzz/pull/10710
...
- It has a C, Go and Rust backend within the repo. Python, C#, Typescript, Java are being considered to serve the full range of Sila clients + fast prototyping in Python.
...
This includes:
- Continuing to follow Sila needs
