...
| 16            | protocol     | a protocol name                           | 32              | any lowercase a-z 0-9 and underscore, padded with NUL bytes | `sila_deneb_kzg`                                                                                                                    | Graceful errors. For namespacing it is recommended to use `{application}_{fork/version/proposal that introduced the trusted setup}_{protocol}` |
