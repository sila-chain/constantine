...
## Run with
##   nim c -r --cc:clang -d:danger --hints:off --warnings:off --outdir:build/wip --nimcache:nimcache/wip benchmarks/sila_sip7594/perf_compute_cells_and_kzg_proofs.nim
##
## Or via nimble:
##   CC=clang nimble bench_sila_sip7594_perf_compute_cells_and_kzg_proofs
...
proc benchComputeCellsAndKZGProofs(b: BenchSet, ctx: ptr SilaKZGContext, iters: int) =
...
proc main() =
  echo "PeerDAS (SIP-7594) - compute_cells_and_kzg_proofs Benchmark"
